...
from modules import create_elements as create
from modules import conversion as convert
from modules import dice_tray as tray
...
def run_script():
    # Run the .exe file for the HP-tracker
    subprocess.run("Health Tracker.exe")
